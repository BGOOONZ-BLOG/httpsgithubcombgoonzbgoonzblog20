...
var _self = 'undefined' != typeof window ? window
    ...
    Prism = (function(g) {
        ...
        util : {
          encode : function(e) {
            return e instanceof M
                   ...
                   : Array.isArray(e) ? e.map(C.util.encode)
                                      : e.replace(/&/g, '&amp;')
                                            .replace(/</g, '&lt;')
                                            .replace(/\u00a0/g, ' ');
          },
          ...
          objId : function(e) {
            return e.__id || Object.defineProperty(e, '__id', {value : ++a}),
                   e.__id;
          },
            ...
            case 'Array':
              return ((a = C.util.objId(e)),
                      t[a]
                          ? t[a]
                          : ((r = []), (t[a] = r),
                             e.forEach(function(e, a) { r[a] = n(e, t); }), r));
            default:
              return e;
            }
          }
        ...
        highlightElement : function(e, a, n) {
          ...
          var l = {
            ...
            code : e.textContent
              ...
              o = function(e) {
                (l.highlightedCode = e), C.hooks.run('before-insert', l),
                    (l.element.innerHTML = l.highlightedCode),
                    C.hooks.run('after-highlight', l),
                    C.hooks.run('complete', l), n && n.call(l.element);
              };
          ...
          for (var o in n)
            if (n.hasOwnProperty(o) && n[o]) {
              ...
              for (var g = 0; g < s.length; ++g) {
                var c = s[g], u = c.inside, h = !!c.lookbehind, f = !!c.greedy,
                    d = 0, m = c.alias;
                  ...
                  if (!(k instanceof M)) {
                    if (f && y != a.length - 1) {
                      if (((c.lastIndex = v), !(x = c.exec(e))))
                        break;
                      for (var b = x.index + (h ? x[1].length : 0),
                               w = x.index + x[0].length, A = y, P = v,
                               O = a.length;
                    ...
                    if (x) {
                      ...
                      if ((E.push(_), S && E.push(S),
                           Array.prototype.splice.apply(a, E),
                           1 != N && C.matchGrammar(e, a, n, y, v, !0, o), i))
                        break;
                    } else if (i)
                      break;
                  }
      ...
      function M(e, a, n, t, r) {
        (this.type = e), (this.content = a), (this.alias = n),
            (this.length = 0 | (t || '').length), (this.greedy = !!r);
      }
      if (((g.Prism = C), (M.stringify = function(e, a) {
             if ('string' == typeof e)
               return e;
             if (Array.isArray(e))
               return e.map(function(e) { return M.stringify(e, a); }).join('');
             var n = {
               type : e.type,
        ...
        return (g.addEventListener &&
                    (C.disableWorkerMessageHandler ||
                     g.addEventListener(
                         'message',
                         function(e) {
                           var a = JSON.parse(e.data), n = a.language,
                               t = a.code, r = a.immediateClose;
      ...
      return (e &&
                  ((C.filename = e.src),
                   C.manual || e.hasAttribute('data-manual') ||
    ...
    var t = (Prism.plugins.toolbar.registerButton = function(t, n) {
      ...
      (e =
          ...
          if (t && /pre/i.test(t.nodeName) &&
            ...
            e.classList.add('code-toolbar'), t.parentNode.insertBefore(e, t),
                e.appendChild(t);
            var o = document.createElement('div');
            o.classList.add('toolbar'),
                document.body.hasAttribute('data-toolbar-order') &&
                    (r = document.body.getAttribute('data-toolbar-order')
                             .split(',')
                             .map(function(t) { return i[t] || n; })),
                r.forEach(function(t) {
                  var e = t(a);
                  if (e) {
                    var n = document.createElement('div');
                    n.classList.add('toolbar-item'), n.appendChild(e),
                        o.appendChild(n);
                  }
                }),
                e.appendChild(o);
  ...
  if ('undefined' != typeof self && self.Prism && self.document)
    if (Prism.plugins.toolbar) {
      ...
      Prism.plugins.toolbar.registerButton('copy-to-clipboard', function(e) {
        ...
        function o() {
          var o = new r(t, {text : function() { return e.code; }});
          o.on('success', function() { (t.textContent = 'Copied'), n(); }),
              o.on('error', function() {
